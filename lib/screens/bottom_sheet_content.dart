                          ...
                          Expanded(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) => InkWell(
                                onTap: () => value.setSelectedItem(index),
                                child: Container(
                                  decoration: BoxDecoration(
                                      ...
                                      color: index == value.selectedItem
                                          ? prmColor
                                          : Colors.transparent,
                                      border: index != value.selectedItem
                                          ? const Border(
                                              left: BorderSide(
                                                  color: Colors.black))
                                          : null),
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: value.getBorderRadius(),
                    color: Colors.white,
                  ),
                  height: value.getContainerHeight(),
                  child: Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () {},
                          child: Text('Show $noOfPlacesAvailable Places'))
                    ],
                  ),
                ),
              ),
